...
export function GroupShopping(){
    return(
        ...
        <div className='projectPageContainer'>
            ...
            <div className='row'>
                <div className='col-md-4'><p>1. <br/>Users can join multiple shopping carts</p></div>
                <div className='col-md-4'><p>2. <br/>Items in cart are separated by who added them. (Easy to figure out who bought what items) </p></div>
                <div className='col-md-4'><p>3. <br/>Allow users to explore different recipes and ingredients</p></div>
            </div>
            <div className="row">
            ...
            <img className='img-fluid img-responsive' src={require('./shopping/Persona1.png')} alt='Persona 1'/>
            <img className='img-fluid img-responsive' src={require('./shopping/Persona2.png')} alt='Persona 2'/>
            <img className='img-fluid img-responsive' src={require('./shopping/Persona3.png')} alt='Persona 3'/>
            ...
            <img className='img-fluid img-responsive' src={require('./shopping/journeyMap1.png')} alt='Group Shopping Journey Map 1' />
            <img className='img-fluid img-responsive' src={require('./shopping/journeyMap2.png')} alt='Group Shopping Journey Map 2'/>

            <h2>Key Takeaways</h2>
            <div className='row'>
                <div className='col-md-4'><p>1. <br/>Because of the pandemic, people prefer to shop online rather than in-person. </p></div>
                <div className='col-md-4'><p>2. <br/>It was difficult to grocery shop for the entire household. Current solutions include using google spreadsheets, a physical paper, or their group chats. The problem is that these solutions usually mean that the responsibilities fall onto one member of the household. </p></div>
                <div className='col-md-4'><p>3. <br/>People missed the serendipitous aspect of grocery shopping.</p></div>
            </div>
            ...
            <img className='img-fluid img-responsive' src={require('./shopping/crazy8.png')} alt='Group Shopping Crazy 8'/>
            ...
            <img className='img-fluid img-responsive' src={require('./shopping/paper.png')} alt='Group Shopping Paper Prototype'/>
            ...
            <div className='row'>
                <div className='col-md-4'><p>1. <br/>“You want to order groceries for your household for the week. Create a shared cart so your housemates can also add to the weekly order.”</p></div>
                <div className='col-md-4'><p>2. <br/>“Find out what items you have in your own cart and the items you and your housemates are sharing.”</p></div>
                <div className='col-md-4'><p>3. <br/>“Your housemate Alex has started their own cart. Join their cart and add an item to the shared cart.”</p></div>
            </div>
            <br/>

            <h2>Key Takeaways</h2>
            <div className='row'>
                <div className='col-md-6'><p>1. <br/>Users brought up the idea of having multiple carts</p></div>
                <div className='col-md-6'><p>2. <br/>Think that buying ingredients from recipes helps with meal planning</p></div>
            </div>
            ...
            <img className='img-fluid img-responsive' src={require('./shopping/multipleCarts.png')} alt='Group Shopping Multiple Carts'/>
            ...
            <img className='img-fluid img-responsive' src={require('./shopping/recipeIdeas.png')} alt='Group Shopping Recipe Ideas'/>
            ...
            <img className='img-fluid img-responsive' src={require('./shopping/narrowingScope.png')} alt='Group Shopping Narrowing Scope'/>
            ...
            <img className='img-fluid img-responsive' src={require('./shopping/substitution.png')} alt='Group Shopping Substitution'/>
            ...
            <img className='img-fluid img-responsive' src={require('./shopping/responsive.png')} alt='Group Shopping Responsiveness'/>
