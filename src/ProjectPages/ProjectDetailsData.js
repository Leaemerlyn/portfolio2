export let ProjectDetailsData = {
    MedBuddy : {
        url: require('../Assets/ProjectCoverImages/MedBuddy.png'),
    ...
    WindStax : {
        url: require('../Assets/ProjectCoverImages/Windstax.png'),
        role: 'UX Designer',
        time: 'January 2021 - March 2021',
        team: 'Sylvia Ding, Tam Nguyen, Alex Hong',
        tools: 'Figma, Personas, Stakeholder Map, Tone & Voice, Mobile First Design',
