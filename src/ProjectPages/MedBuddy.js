...
export function MedBuddy(){
    return(
        ...
        <img className='img-fluid img-responsive' src={require('./medBuddy/videoStoryboard.png')}/>
        ...
        <img className='img-fluid img-responsive' src={require('./medBuddy/refinedVideoStoryboard.png')}/>
        ...
        <img className='img-fluid img-responsive' src={require('./medBuddy/roughCut.png')}/>
        
        <h2>Rough Cut Feedback</h2>
        <img className='img-fluid img-responsive' src={require('./medBuddy/roughCutFeedback.png')}/>

        <h2>Refined Cut</h2>
        <img className='img-fluid img-responsive' src={require('./medBuddy/refinedCut.png')}/>
        ...
        <div className='row'>
            <div className='col-4'><p>1. <br/>using After Effects for callouts and animations
</p></div>
            <div className='col-4'><p>2. <br/>Using more descriptive labels in photos, adding better flow between script and storyboard
</p></div>
            <div className='col-4'><p>3. <br/>Small details like phone mockup screen
</p></div>
        </div>
        <hr/>
